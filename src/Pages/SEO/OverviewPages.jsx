...
export function ServicesOverview() {
  return (
    <>
      <SEO
        title="სარეცხი მანქანის სერვისები თბილისში | DrWash"
        description="სარეცხი მანქანის შეკეთება, დიაგნოსტიკა, მონტაჟი, გაწმენდა და მოვლა თბილისში ადგილზე მისვლით. გაეცანით DrWash-ის სერვისებს."
        path="/services"
      />
      <Breadcrumbs items={[{ label: "მთავარი", path: "/" }, { label: "სერვისები", path: "/services" }]} />
      <PageHero
        eyebrow="DrWash სერვისები"
...
export function ProblemsOverview() {
  return (
    <>
      <SEO
        title="სარეცხი მანქანის პრობლემები და შეკეთება | DrWash"
...
export function BrandsOverview() {
  return (
    <>
      <SEO
        title="სარეცხი მანქანის ბრენდების შეკეთება თბილისში | DrWash"
...
export function LocationsOverview() {
  return (
    <>
      <SEO
        title="სარეცხი მანქანის ხელოსანი თბილისის უბნებში | DrWash"
      ...
      <PageHero
        ...
        intro="DrWash მუშაობს თბილისში, როგორც სერვის-არეალის ბიზნესი. საჯარო ოფისის მისამართის ნაცვლად ტექნიკოსის ვიზიტი მომხმარებლის მისამართზე წინასწარი შეთანხმებით იგეგმება."
      />
