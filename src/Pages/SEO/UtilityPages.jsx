...
export function PricesPage() {
  ...
  return (
    <>
      <SEO
        title="სარეცხი მანქანის შეკეთების ფასები თბილისში | Sarecxo"
...
export function FAQPage() {
  return (
    <>
      <SEO
        title="ხშირად დასმული კითხვები | სარეცხი მანქანის სერვისი | Sarecxo"
...
export function ContactPage() {
  return (
    <>
      <SEO
        title="კონტაქტი | სარეცხი მანქანის ხელოსანი თბილისში | Sarecxo"
        description="დაუკავშირდით Sarecxo-ს სარეცხი მანქანის შეკეთების, დიაგნოსტიკის ან მონტაჟისთვის თბილისში. ტელეფონი, WhatsApp, სამუშაო საათები და უბნები."
        path="/contact"
      />
      <JsonLd data={localBusinessSchema()} />
      <Breadcrumbs items={[{ label: "მთავარი", path: "/" }, { label: "კონტაქტი", path: "/contact" }]} />
      <PageHero
        eyebrow="Sarecxo კონტაქტი"
      ...
      <Section title="მომსახურების უბნები">
        ...
        <p className="mt-5 max-w-3xl leading-7 text-slate-600">
          Sarecxo არის სერვის-არეალის ბიზნესი. საჯარო ოფისის მისამართი არ არის
...
export function BlogPage() {
  return (
    <>
      <SEO
        title="სარეცხი მანქანის მოვლა და პრობლემების გზამკვლევი | Sarecxo"
